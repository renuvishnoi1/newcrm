                                ...
                                <tbody class="tbody">
                                  ...
                                  <?php if(count(array_filter($quote_item)) >0){ foreach ($quote_item as $key => $values) { ?>
                                   <tr class="after-add-more item">
                                     <td >
                                      <fieldset class="form-group"><textarea class="form-control " id="description_<?= $values['id']; ?>" rows="3" name="quote_item[description][]" placeholder="Description"><?php echo $values['description'] ; ?></textarea><input type="hidden" id="item_id<?= $values['id']; ?>" value="<?= $values['id']; ?>"/></fieldset>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                      <fieldset class="form-group"><input type="number" value="<?php echo $values['rate'] ; ?>" name="quote_item[rate][]" id="rate<?= $values['id']; ?>" onchange="update_amounts();" class="form-control rate rate<?= $values['id']; ?>" data-id="<?= $values['id']; ?>"></fieldset>
                                    </td>
                                    <td>
                                      <input type="hidden" name="quote_item[item_id][]" value="<?= $values['id']; ?>">
                                      <fieldset class="form-group">
                                       <select name="quote_item[tax_rate][]" class="form-control tax" id="tax<?= $values['id']; ?>">
                                  ...
                                  <td ><span class="sub_total sb<?= $values['id']; ?>" id="total">0.00<span></td>
                                   <td><a href="javascript:void(0);" class="remCF" onclick="remove_i(<?= $values['id']; ?>);">Remove</a></td>
                                 </tr>
                               <?php }
                             } ?>
...
function remove_i(id){
  ...
  if (r==true){
   ...
   var dataJson = { [csrfName]: csrfHash, id:id};
   $.ajax({
    url:"<?php echo base_url('admin/QuoteController/remove_item'); ?>",
    type:"POST",
    data:dataJson,
    success:function(res)
    {

                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                      <form action="<?php echo base_url('admin/update_tax'); ?>" method="POST">
                                         <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    <label for="basicInput"> Name</label>
                                                    <input type="text" name="name" class="form-control" id="basicInput" value="<?php echo $tax->name; ?>">
                                                    <input type="hidden" name="id" value="<?php echo $tax->id; ?>">
                                                    <span class="text-danger"><?php echo form_error('name'); ?></span>
                                                </fieldset>
                                                   <fieldset class="form-group">
                                                    <label for="helpInputTop">Tax Rate (percent)</label>
                                                    <input type="number" class="form-control "  name="taxrate" value="<?php echo $tax->taxrate ?>">
                                                </fieldset>
